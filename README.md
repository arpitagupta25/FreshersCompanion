...
The project was developed as part of the Campus Connect Competition, organized by the Chakravyuhah Club. The objective of the competition was to create a static website that enhances the fresher onboarding experience by making essential information easily accessible.

The platform brings together academic guidance, campus resources, hostel information, student communities, survival tips, useful tools, and frequently asked questions into a single, intuitive interface.
...
Event & Club Notifications
Senior-Junior Mentorship Portal
...
React and TypeScript-based frontend development
